	...
	\section{Obrazová data pro slu¾bu Panorama}\label{ch:data}
		...
		\subsection{Se¹ívání fotografií}
			...
			\begin{figure}[h]
				...
				\caption{Se¹ívání 14 snímkù s pøekryvem do jedné panoramatické fotografie. Poslední snímek z horní kamery slou¾í k doplnìní volných míst v horní èásti fotografie.}
				\label{sesivani}
			\end{figure} 
...
\chapter{Neuronové sítì}\label{ch:neuronky}
	...
	\section{Vícevrstvé neuronové sítì}\label{ch:neuralnets}
		...
		\begin{description}
			...
			\item[Hledání vzorù] - na vstup je pøilo¾en vektor a na výstupu je vygenerován vzor, který nejlépe popisuje vektor poskytnutý na vstupu.
			\item[Doplòování vzorù] - na vstup je pøilo¾en vektor znázoròující èást hledaného vzoru. Na výstup jsou potom dotvoøeny chybìjící èásti vzoru.
