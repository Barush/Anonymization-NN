...
\projectinfo{
  ...
  %===========================================================================
  %Klicova slova
  keywords.cs={Detekce, anonymizace, státní poznávací znaèky, neuronové sítì, hluboké neuronové sítì, zpracování osobních údajù.}, %klicova slova v ceskem jazyce
  ...
  %Abstract
  abstract.cs={V rámci procházení online map jsou dnes dostupné i souvislé snímky prohlí¾ených míst. Pokud jsou v¹ak snímky poøizovány ve veøejném prostoru, nacházejí se na nich i kolemjdoucí lidé a kolemjedoucí auta, co¾ není ¾ádoucí. V rámci této práce je zpracovávána problematika automatizované anonymizace státních poznávacích znaèek v obrazových datech zachycených na veøejných prostranstvích. Øe¹ení je dosahováno s vyu¾itím hlubokých neuronových sítí.}, % abstrakt v ceskem jazyce
